...
//notifyAll(),唤醒所有线程，然后以一个随机的序列以此获取对象锁，以此执行
//看运行结果，会发现，ThreadA、ThreadC和ThreadD会以一个随即顺序被依次唤醒
public class T22_Wait_Notify {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//睡眠4000ms以让线程A,C,D都获得message的对象锁并进入等待状态
		Thread.sleep(4000);
		//B线程获取message的对象锁，给message+1000，然后调用wait.notifyAll(),以准备释放对象锁并通知正在阻塞等待message对象锁的线程。
